...
def measure_current_map() -> dict:
    ...
    op_save = [
        ...
        "@m.xtop.xxdut.xanalog_core.xpin_l.msky130_fd_pr__pfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xpin_r.msky130_fd_pr__pfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xnin_l.msky130_fd_pr__nfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xnin_r.msky130_fd_pr__nfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xfc_p1_l.msky130_fd_pr__pfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xfc_p1_r.msky130_fd_pr__pfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xfc_n1_l.msky130_fd_pr__nfet_01v8[id]",
        "@m.xtop.xxdut.xanalog_core.xfc_n1_r.msky130_fd_pr__nfet_01v8[id]",
    ...
    payload = {
        ...
        "m24_gate_mid_A": abs(float(d["i(@m.xtop.xxdut.xbias.xmp_ibias_p_out.msky130_fd_pr__pfet_01v8[id])"])),
        "m35_gate_mid_A": abs(float(d["i(@m.xtop.xxdut.xbias.xmn_ibias_n_out.msky130_fd_pr__nfet_01v8[id])"])),
        "frontend_pinp_l_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xpin_l.msky130_fd_pr__pfet_01v8[id])"])),
        "frontend_pinp_r_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xpin_r.msky130_fd_pr__pfet_01v8[id])"])),
        "frontend_ninp_l_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xnin_l.msky130_fd_pr__nfet_01v8[id])"])),
        "frontend_ninp_r_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xnin_r.msky130_fd_pr__nfet_01v8[id])"])),
        "frontend_mpb1_l_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xfc_p1_l.msky130_fd_pr__pfet_01v8[id])"])),
        "frontend_mpb1_r_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xfc_p1_r.msky130_fd_pr__pfet_01v8[id])"])),
        "frontend_mnb3_l_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xfc_n1_l.msky130_fd_pr__nfet_01v8[id])"])),
        "frontend_mnb3_r_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xfc_n1_r.msky130_fd_pr__nfet_01v8[id])"])),
        "mont_n_bridge_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xm24.msky130_fd_pr__nfet_01v8[id])"])),
        "mont_p_bridge_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xm35.msky130_fd_pr__pfet_01v8[id])"])),
        "out_n_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xm1.msky130_fd_pr__nfet_01v8[id])"])),
        "out_p_A": abs(float(d["i(@m.xtop.xxdut.xanalog_core.xm2.msky130_fd_pr__pfet_01v8[id])"])),
