...
VERIFICATION_PLAN = {
    ...
    "on_smoke": {
        "specification_aspect": "on-state qualitative switch behavior",
        "category": "contract",
        "test_name": "run_on_test",
        "analysis_type": "Op",
        "extracted_metrics": ["simulation completion", "v(xtop.b)"],
        "pass_fail_rule": "smoke test only; no formal numeric acceptance criterion yet",
        "required_corners": ["TT"],
        "required_operating_conditions": [],
        "monte_carlo_required": False,
    },
    "off_smoke": {
        "specification_aspect": "off-state qualitative switch behavior",
        "category": "contract",
        "test_name": "run_off_test",
        "analysis_type": "Op",
        "extracted_metrics": ["simulation completion", "v(xtop.b)"],
        "pass_fail_rule": "smoke test only; no formal numeric acceptance criterion yet",
        "required_corners": ["TT"],
