...
VERIFICATION_PLAN = {
    ...
    "nominal_op_tt": {
        "test": "run_op_test",
        "analysis": "Op",
        "metrics": ["v(out)", "i(vvdd)"],
        "rule": "nominal smoke test only",
        "corners": ["TT"],
        "sweeps": [],
        "monte_carlo": False,
    },
    "bias_order_tt": {
        "test": "run_bias_order_test",
        "analysis": "Op",
        "metrics": ["v(out) at low bias", "v(out) at high bias", "v(out)_low - v(out)_high"],
        "rule": "higher bias should increase sink current and lower OUT",
        "corners": ["TT"],
        "sweeps": ["v_bias"],
        "monte_carlo": False,
    },
