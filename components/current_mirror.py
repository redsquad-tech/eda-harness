...
VERIFICATION_PLAN = {
    ...
    "mirror_op_tt": {
        "specification_aspect": "mirror ratio tracking behavior",
        "category": "contract",
        "test_name": "run_mirror_test",
        "analysis_type": "Op",
        "extracted_metrics": ["v(out)", "i_out_est", "i_ref", "i_out_est / i_ref"],
        "pass_fail_rule": "output branch current should qualitatively track mirror ratio",
        "required_corners": ["TT"],
        "required_operating_conditions": [],
        "monte_carlo_required": False,
    },
    "ratio_order_tt": {
        "specification_aspect": "mirror-ratio monotonicity",
        "category": "contract",
        "test_name": "run_ratio_order_test",
        "analysis_type": "Op",
        "extracted_metrics": ["i_out_est at low ratio", "i_out_est at high ratio"],
        "pass_fail_rule": "higher ratio should increase mirrored output current",
        "required_corners": ["TT"],
        "required_operating_conditions": ["ratio"],
        "monte_carlo_required": False,
    },
}
