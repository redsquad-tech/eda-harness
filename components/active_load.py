...
VERIFICATION_PLAN = {
    ...
    "balanced_op_tt": {
        "specification_aspect": "balanced active-load behavior",
        "category": "contract",
        "test_name": "run_balanced_test",
        "analysis_type": "Op",
        "extracted_metrics": ["v(outp)", "v(outn)", "abs(v(outp)-v(outn))"],
        "pass_fail_rule": "balanced reference currents keep outputs close",
        "required_corners": ["TT"],
        "required_operating_conditions": [],
        "monte_carlo_required": False,
    },
    "steer_op_tt": {
        "specification_aspect": "active-load output ordering",
        "category": "contract",
        "test_name": "run_steer_test",
        "analysis_type": "Op",
        "extracted_metrics": ["v(outp)", "v(outn)", "output delta"],
        "pass_fail_rule": "output ordering follows reference-current ordering and cross-coupling mode",
        "required_corners": ["TT"],
        "required_operating_conditions": ["i_ref_p", "i_ref_n"],
        "monte_carlo_required": False,
    },
}
