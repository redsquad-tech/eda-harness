...
VERIFICATION_PLAN = {
    "structural": {
        ...
        "metrics": ["generator call", "elaboration", "subckt name", "MOS presence"],
    ...
    "tran_smoke_tt": {
        "test": "run_tran_test",
        "analysis": "Tran",
        "metrics": ["phi1 max", "phi2 max", "max overlap"],
        "rule": "both phases switch and overlap stays low",
        "corners": ["TT"],
        "sweeps": ["pulse clock over several cycles"],
        "monte_carlo": False,
    },
}
