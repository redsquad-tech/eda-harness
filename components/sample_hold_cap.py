...
VERIFICATION_PLAN = {
    "structural": {
        ...
        "metrics": ["generator call", "elaboration", "subckt name", "cap cell presence"],
    ...
    "ac_smoke_tt": {
        "test": "run_ac_test",
        "analysis": "Ac",
        "metrics": ["source current magnitude"],
        "rule": "AC current magnitude is non-zero at TT",
        "corners": ["TT"],
        "sweeps": ["1 kHz to 1 MHz"],
        "monte_carlo": False,
    },
}
