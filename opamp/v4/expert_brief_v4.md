...
```bash
python3 -m opamp.v4.debug_sweeps
```

Артефакты:

- `opamp/v4/debug_sweeps_v4.md`
- `opamp/v4/debug_sweeps_v4.json`
...
- чистый netlist без debug MUX / replica / scan-proxy:
  - `opamp/v4/neuron_core_oa_sky130.spice`
- рабочий DUT netlist:
  - `opamp/v4/neuron_core_oa_sky130.spice`
- debug summary:
  - `opamp/v4/debug_sweeps_v4.md`
- spec compliance:
  - `opamp/v4/spec_compliance_v4.md`
