...
from opamp.v4.opamp import NeuronOaParams, compile_for_sky130
...
class TestV4BiasGeneratorIsolated(BaseV4SimTest):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.metrics["summary"] = {
            "i0_p_match_ratio": cls.metrics["id_i0_p_A"] / max(cls.metrics["id_i0_p_sink_A"], 1e-30),
            "ibias_p_match_ratio": cls.metrics["id_ibias_p_A"] / max(cls.metrics["id_ibias_p_sink_A"], 1e-30),
            "i0_n_match_ratio": cls.metrics["id_i0_n_feed_A"] / max(cls.metrics["id_i0_n_A"], 1e-30),
            "ibias_n_match_ratio": cls.metrics["id_ibias_n_feed_A"] / max(cls.metrics["id_ibias_n_A"], 1e-30),
        }
