...
def build_tapeout_validation_plan() -> list[TapeoutValidationCase]:
    return [
        ...
        TapeoutValidationCase(
            ...
            level="top",
            fixture="sc_loop",
            implementation_status="v1_available",
            ...
            python_test_module="opamp.v1.tests.structural.opamp_az_top.test_opamp_az_top__char__reduced_pvt",
        ),
        TapeoutValidationCase(
        ...
        TapeoutValidationCase(
            ...
            metrics=("residual_offset_uV", "pedestal_mid50_uV", "settling_mid50_uV"),
            corners=("TT / 1.8 V / 27 C",),
            pass_fail_rule="v1 legacy nominal precision budget",
            python_test_module="opamp.v1.tests.structural.opamp_az_top.test_opamp_az_top__budget__precision_ppa",
        ),
        TapeoutValidationCase(
