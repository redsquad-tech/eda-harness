...
from opamp.v2.gm_stage import run_dc_transfer_test
from opamp.v2.tests._helpers import BaseV2SimTest


class TestGmStageV2CharDcTransfer(BaseV2SimTest):
    def test_gm_stage_v2__char__dc_transfer(self) -> None:
        result = run_dc_transfer_test()
